...
confirmed_cases_china = read.csv('confirmed_cases_china_vs_world.csv')
...
confirmed_cases_top7_outofchina = read.csv('confirmed_cases_top7_outside_china.csv')
...
```{r, echo=TRUE}
#confirmed cases China
coronavirus = read.csv('coronavirus_dataset.csv')
